# Restore Boot Camp Brightness Fn Keys

### _The actual download is on the [Releases](https://github.com/wad11656/Restore-Boot-Camp-Brightness-Keys/releases) page._ ###

See my key-configurable version of this app for non-Boot-Camp/vanilla Windows installs here: https://github.com/wad11656/BrightKeyMap.
...
In addition to restoring the brightness keys, this program also enables the trackpad&#39;s &quot;Tap to Click&quot; and two-finger "Secondary Click" (a.k.a. right-click) options in **Boot Camp Control Panel** on each login to prevent needing to manually enable these settings after every boot. (Not sure if anyone else in the universe even has either of these issues..):
